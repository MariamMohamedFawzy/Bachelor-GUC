...
public class Business implements Serializable {
    ...
    private HashMap<Integer, Double> topicsValues = new HashMap<Integer, Double>();
    
    private int id;
    
    public HashMap<Integer, Double> getTopicsValues() {
		return topicsValues;
	}

	public void setTopicsValues(HashMap<Integer, Double> topicsValues) {
		this.topicsValues = topicsValues;
	}
